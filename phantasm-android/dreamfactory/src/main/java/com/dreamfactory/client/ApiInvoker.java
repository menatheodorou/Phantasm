...
import static com.dreamfactory.client.JsonUtil.*;
	...
	public static Object deserialize(String json, String containerType, Class cls) throws ApiException {
		try{
			if("List".equals(containerType)) {
				JavaType typeInfo = getJsonMapper().getTypeFactory().constructCollectionType(List.class, cls);
				List response = (List<?>) getJsonMapper().readValue(json, typeInfo);
				return response;
			}
				...
				return getJsonMapper().readValue(json, cls);
			}
		}
		catch (IOException e) {
