 ...
 */
public class PTSigninPhoneNumberFragment extends PTBaseFragment {
    ...
    public static PTSigninPhoneNumberFragment newInstance() {
        return new PTSigninPhoneNumberFragment();
    }
    ...
    protected void initUI() {
        ...
        TextView tvLinkSignup = (TextView) findViewById(R.id.tv_link_verify);
...
//        TelecomManager manager = (TelecomManager) getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    private void onClickConfirm() {
        mConnectFragment.gotoNextFragment(PTConnectFragment.FRAGMENT_TAG_VERIFY_PHONE_NUMBER);
    }
}
