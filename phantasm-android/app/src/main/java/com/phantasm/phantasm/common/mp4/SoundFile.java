...
public class SoundFile {
    ...
    // A SoundFile object should only be created using the static methods create() and ic_record().
    private SoundFile() {
    }
        ...
        while (true) {
            ...
            if (!done_reading && inputBufferIndex >= 0) {
                ...
                if (firstSampleData
                    ...
                    // crash. These two bytes do not contain music data but basic PTLoginAPIInfo on the
            ...
            if ((info.flags & MediaCodec.BUFFER_FLAG_END_OF_STREAM) != 0
                ...
                // Theoretically dequeueOutputBuffer(PTLoginAPIInfo, ...) should have set PTLoginAPIInfo.flags to
